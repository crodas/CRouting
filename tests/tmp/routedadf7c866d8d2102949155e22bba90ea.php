...
function routedadf7c866d8d2102949155e22bba90ea($url) {
	...
	switch ($length) {
		...
		case 2:
			...
			if ((($parts[0] == 'rest')) AND ((($offset_1_1 = strpos($parts[1],'.',0)) !== false OR true) AND (($offset_1_3 = strpos($parts[1],'.',$offset_1_1 + 1)) !== false OR true) AND (($value_1_0 = substr($parts[1],0,$offset_1_1))) AND ($offset_1_1 !== false AND ($value_1_2 = substr($parts[1],1 + $offset_1_1,$offset_1_3 - (1 + $offset_1_1))) OR (($value_1_2 = 'status') !== false)) AND ($offset_1_3 !== false AND ($value_1_4 = substr($parts[1],1 + $offset_1_3)) OR (($value_1_4 = 'json') !== false)))) {
				/* /rest/{id}.{action}.{format} */
				return(array('controller' => 'rest', 'id' => $value_1_0, 'action' => $value_1_2, 'format' => $value_1_4));
			}
		...
		case 3:
			if (((($offset_3_1 = strpos($parts[2],'a',0)) !== false) AND (($offset_3_3 = strpos($parts[2],'b',$offset_3_1 + 1)) !== false) AND (($offset_3_5 = strpos($parts[2],'.',$offset_3_3 + 1)) !== false OR true) AND ($offset_3_1 !== false AND ($value_3_0 = substr($parts[2],0,$offset_3_1)) OR (($value_3_0 = 4) !== false)) AND ($offset_3_1 == false OR false === strpos($value_3_0,'.') AND is_numeric($value_3_0)) AND ($offset_3_1 !== false AND ($value_3_2 = substr($parts[2],1 + $offset_3_1,$offset_3_3 - (1 + $offset_3_1))) OR (($value_3_2 = 5) !== false)) AND ($offset_3_1 == false OR false === strpos($value_3_2,'.') AND is_numeric($value_3_2)) AND ($offset_3_3 !== false AND ($value_3_4 = substr($parts[2],1 + $offset_3_3,$offset_3_5 - (1 + $offset_3_3))) OR (($value_3_4 = 6) !== false)) AND ($offset_3_3 == false OR false === strpos($value_3_4,'.') AND is_numeric($value_3_4)) AND ($offset_3_5 !== false AND ($value_3_6 = substr($parts[2],1 + $offset_3_5)) OR (($value_3_6 = 'php') !== false)) AND ($offset_3_5 == false OR ('php' == $value_3_6) OR ('xml' == $value_3_6) OR ('json' == $value_3_6)))) {
		...
		case 4:
			if (((false === strpos($parts[1],'.') AND is_numeric($parts[1]))) AND ((($offset_3_1 = strpos($parts[3],'a',0)) !== false) AND (($offset_3_3 = strpos($parts[3],'b',$offset_3_1 + 1)) !== false) AND (($offset_3_5 = strpos($parts[3],'.',$offset_3_3 + 1)) !== false OR true) AND ($offset_3_1 !== false AND ($value_3_0 = substr($parts[3],0,$offset_3_1)) OR (($value_3_0 = 4) !== false)) AND ($offset_3_1 == false OR false === strpos($value_3_0,'.') AND is_numeric($value_3_0)) AND ($offset_3_1 !== false AND ($value_3_2 = substr($parts[3],1 + $offset_3_1,$offset_3_3 - (1 + $offset_3_1))) OR (($value_3_2 = 5) !== false)) AND ($offset_3_1 == false OR false === strpos($value_3_2,'.') AND is_numeric($value_3_2)) AND ($offset_3_3 !== false AND ($value_3_4 = substr($parts[3],1 + $offset_3_3,$offset_3_5 - (1 + $offset_3_3))) OR (($value_3_4 = 6) !== false)) AND ($offset_3_3 == false OR false === strpos($value_3_4,'.') AND is_numeric($value_3_4)) AND ($offset_3_5 !== false AND ($value_3_6 = substr($parts[3],1 + $offset_3_5)) OR (($value_3_6 = 'php') !== false)) AND ($offset_3_5 == false OR ('php' == $value_3_6) OR ('xml' == $value_3_6) OR ('json' == $value_3_6)))) {
				/* /y/{three}/x/{four}a{five}b{six}.{ext} */
...
function routedadf7c866d8d2102949155e22bba90eaBuild($name,$parts) {
	...
	switch ($name) {
		...
		case 'dotdot':
			...
			return('/rest/'.$parts['id'].'.'.$parts['action'].'.'.$parts['format']);
			break;
